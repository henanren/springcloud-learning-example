...
public class ConsumerRibbonHystrixThreadPoolService {
    ...
    public String testDefaultThreadPoolKey(String name){
        logger.info("testDefaultThreadPoolKey service invoke, thread is " + Thread.currentThread().getName());
    ...
    private String testDefaultThreadPoolKeyFallback(String name, Throwable t){
        logger.info("testDefaultThreadPoolKey fallback invoke, thread is " + Thread.currentThread().getName() + ",exception is " + t);
